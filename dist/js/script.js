...
const burger = () => {
  ...
  burger === null || burger === void 0 ? void 0 : burger.addEventListener("click", () => {
    ...
    if (menu !== null && menu !== void 0 && menu.classList.contains("menu--active")) {
      ...
      burger === null || burger === void 0 ? void 0 : burger.setAttribute("aria-label", "Закрыть меню"); // Change overlay activness

      overlay === null || overlay === void 0 ? void 0 : overlay.setAttribute("data-overlay", "true"); // Disabling scroll
      ...
      burger === null || burger === void 0 ? void 0 : burger.setAttribute("aria-label", "Открыть меню"); // Change overlay activness

      overlay === null || overlay === void 0 ? void 0 : overlay.setAttribute("data-overlay", "false"); // Enabling scroll
  ...
  overlay === null || overlay === void 0 ? void 0 : overlay.addEventListener("click", e => {
    if (e.target && e.target.hasAttribute("data-overlay")) {
      ...
      overlay === null || overlay === void 0 ? void 0 : overlay.setAttribute("data-overlay", "false"); // Change classess

      burger === null || burger === void 0 ? void 0 : burger.classList.remove("burger--active");
      menu === null || menu === void 0 ? void 0 : menu.classList.remove("menu--active"); // Enabling scroll
...
window.addEventListener("DOMContentLoaded", () => {
  // mobileCheck();
  (0,_functions_accordion__WEBPACK_IMPORTED_MODULE_3__.accordion)(".faq__body", "faq__question", ".faq__wrapper", "faq__wrapper--active");
  (0,_functions_burger__WEBPACK_IMPORTED_MODULE_2__.burger)(); // formValidation();
});
})();
