...
const swiper = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"](); // Подключение плавной прокрутки к якорям (подключать в случае если плавная прокрутка нужна в Safari)
...
/* harmony import */ var _components_mainSlider__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/mainSlider */ "./src/js/components/mainSlider.js");
...
window.addEventListener("DOMContentLoaded", () => {
  (0,_functions_mobile_check__WEBPACK_IMPORTED_MODULE_1__.mobileCheck)(); // burger();
  // formValidation();

  (0,_components_mainSlider__WEBPACK_IMPORTED_MODULE_2__.mainSlider)();
});
})();
